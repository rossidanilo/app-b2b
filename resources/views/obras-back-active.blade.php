    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="row text-center">
            <div class="col">
              <a href="/admin/obras/active" class="btn btn-info">OBRAS ACTIVAS</a>
            </div>
            <div class="col">
              <a href="/admin/obras" class="btn btn-info">VER OBRAS PENDIENTES</a>
            </div>
            <div class="col">
              <a href="/admin/obras/finished" class="btn btn-info">OBRAS FINALIZADAS</a>
            </div>          
          </div>
          <div class="col-12 mt-3 p-0">
            <form method="GET" class="mr-auto ml-auto" action="/admin/obras/active/search">
